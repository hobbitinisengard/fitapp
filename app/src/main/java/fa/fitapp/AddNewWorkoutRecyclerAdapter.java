...
import fa.fitapp.ExerciseSet;
import fa.fitapp.R;

public class AddNewWorkoutRecyclerAdapter extends RecyclerView.Adapter<AddNewWorkoutRecyclerAdapter.ViewHolder>{

    private List<WorkoutExerciseSet> mData;
    private LayoutInflater mInflater;

    // data is passed into the constructor
    AddNewWorkoutRecyclerAdapter(Context context, List<WorkoutExerciseSet> data) {
